...
ar71xx_get_mtd_offset_size_format_cs() {
	local dev="$1"
	local offset="$2"
	local size="$3"
	local format="$4"
...
ar71xx_get_mtd_part_macaddr() {
	local mtd="$1"
	ar71xx_get_mtd_offset_size_format_cs "$mtd" 4098 6 %02x
}
...
ar71xx_board_detect() {
	...
	*"AP147 reference board")
		name="ap147"
		;;
	*"CS811R reference board")
		name="CS811R"
		;;
	*"CSB811A reference board")
		name="CSB811A"
		;;
	*"CSB810A_N0 reference board")
		name="CSB810A_N0"
		;;
	*"CSB810A_EN reference board")
		name="CSB810A_EN"
		;;
	*"CS810R_N0 reference board")
		name="CS810R_N0"
		;;
