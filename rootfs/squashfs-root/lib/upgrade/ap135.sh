...
platform_do_upgrade_ap135() {
	...
	"CSB810A_EN" |\
	"CS810R_N0")
		mtd write /tmp/firmware.img firmware
		;;	
	"CSBXXXXXXX")
		dd if=/tmp/firmware.img of=/tmp/kernel bs=65536 count=23
		dd if=/tmp/firmware.img of=/tmp/rootfs bs=65536 count=97 skip=23
